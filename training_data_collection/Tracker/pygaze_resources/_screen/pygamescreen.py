...
class PyGameScreen(BaseScreen):
    ...
    def draw_circle(self, colour=None, color=None, pos=None, r=50, pw=1, fill=False):
    ...
    def draw_ellipse(self, colour=None, color=None, x=None, y=None, w=50, h=50, pw=1, fill=False):
    ...
    def draw_rect(self, colour=None, color=None, x=None, y=None, w=50, h=50, pw=1, fill=False):
    ...
    def draw_polygon(self, pointlist, colour=None, color=None, pw=1, fill=True):
    ...
    def draw_fixation(self, fixtype="cross", colour=None, color=None, pos=None, pw=1, diameter=12):
    ...
    def draw_text(self, text="text", colour=None, color=None, pos=None,
        ...
        fontname = os.path.join(settings.FONTDIR, font) + ".ttf"
