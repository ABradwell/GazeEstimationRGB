...
from .._misc.misc import pos2psychopos, psychopos2pos, rgb2psychorgb
from .._screen.basescreen import BaseScreen
...
class PsychoPyScreen(BaseScreen):
    ...
    def __init__(self, dispsize=settings.DISPSIZE, fgc=settings.FGC,  bgc=settings.BGC, screennr=settings.SCREENNR,
