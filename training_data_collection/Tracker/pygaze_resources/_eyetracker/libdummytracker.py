...
class Dummy(DumbDummy):
    ...
    def __init__(self, display):
        ...
        self.simulator = Mouse(disptype=settings.DISPTYPE, mousebuttonlist=None, timeout=2, visible=False)
        self.kb = Keyboard(disptype=settings.DISPTYPE, keylist=None, timeout=None)
