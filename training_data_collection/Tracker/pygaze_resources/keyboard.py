...
from ._keyboard.basekeyboard import BaseKeyboard
...
class Keyboard(BaseKeyboard):
    ...
    def __init__(self, disptype=settings.DISPTYPE, **args):
        ...
        if disptype == "pygame":
            from ._keyboard.pygamekeyboard import PyGameKeyboard as Keyboard
        elif disptype == "psychopy":
            from ._keyboard.psychopykeyboard import PsychoPyKeyboard as Keyboard
        elif disptype == "opensesame":
            from ._keyboard.oskeyboard import OSKeyboard as Keyboard
        else:
