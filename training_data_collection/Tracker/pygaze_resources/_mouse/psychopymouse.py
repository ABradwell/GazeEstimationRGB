...
from .._mouse.basemouse import BaseMouse
...
from .._misc.misc import pos2psychopos, psychopos2pos
import psychopy.event


class PsychoPyMouse(BaseMouse):

    def __init__(self, mousebuttonlist=settings.MOUSEBUTTONLIST, timeout=settings.MOUSETIMEOUT, visible=False):
        ...
        # create mouse object
        #TODO how do i remove this?
        self.mouse = psychopy.event.Mouse(visible=False, win=pygaze.expdisplay)
