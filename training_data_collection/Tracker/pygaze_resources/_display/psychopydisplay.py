...
from .. import *
from .._misc.misc import rgb2psychorgb
...
class PsychoPyDisplay(BaseDisplay):
    ...
    def __init__(self, dispsize=settings.DISPSIZE, fgc=settings.FGC,
        ...
        # create window
        self.display = Window(size=self.dispsize, pos=None,
        ...
        self.display.setMouseVisible(self.mousevis)
    ...
    def make_screenshot(self, filename="screenshot.png"):
        ...
        self.display.saveMovieFrames(filename)
